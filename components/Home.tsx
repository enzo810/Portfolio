...
const Home = () => {
  return (
    <section className="flex flex-col xl:flex-row items-center xl:justify-between max-xs:mt-22 mt-32 xl:mt-60">
      <div className="text-center xl:text-left order-2 xl:order-1 mt-4 xl:mt-0">
        <span className="text-xl">Web developer</span>
        <h1 className="h1 mb-2">
          Hello I&apos;m <br />
          <span className="text-neon drop-shadow-neon">Sousa Enzo</span>
        </h1>
        <p className="max-w-[500px] mb-4 break-words">
          I am 20 years old, a full-stack developer in training at Epitech and
          in alternance at Creach Agency, coding for two years.
        </p>

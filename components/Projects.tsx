...
const projects = [
  ...
  },
  {
    ...
    icon: FaGamepad,
    description:
      "Game of the Morpion realized to exercise the algorythmic logic.",
  },
  {
    ...
    icon: FaImage,
    description: "Generator based on recursion and files manipulation.",
  },
  {
    label: "Battleship",
    ...
    icon: FaShip,
    description: "Game based on advanced management of tables and JS modules.",
  },
  {
    label: "Neatlead",
    ...
    icon: CgWorkAlt,
    description:
      "One of my alternance feature. We developped a CRM, check nextlead.app.",
  },
];
